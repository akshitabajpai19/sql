...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_avm-res-network-privatednszone"></a> [avm-res-network-privatednszone](#module\_avm-res-network-privatednszone) | Azure/avm-res-network-privatednszone/azurerm | 0.1.2 |
...
| Name | Description |
|------|-------------|
| <a name="output_a_record_outputs"></a> [a\_record\_outputs](#output\_a\_record\_outputs) | n/a |
| <a name="output_aaaa_record_outputs"></a> [aaaa\_record\_outputs](#output\_aaaa\_record\_outputs) | n/a |
| <a name="output_cname_record_outputs"></a> [cname\_record\_outputs](#output\_cname\_record\_outputs) | n/a |
...
| <a name="output_mx_record_outputs"></a> [mx\_record\_outputs](#output\_mx\_record\_outputs) | n/a |
| <a name="output_privatednszone"></a> [privatednszone](#output\_privatednszone) | The private dns zone details |
| <a name="output_ptr_record_outputs"></a> [ptr\_record\_outputs](#output\_ptr\_record\_outputs) | n/a |
| <a name="output_srv_record_outputs"></a> [srv\_record\_outputs](#output\_srv\_record\_outputs) | n/a |
| <a name="output_txt_record_outputs"></a> [txt\_record\_outputs](#output\_txt\_record\_outputs) | n/a |
| <a name="output_virtual_network_link_outputs"></a> [virtual\_network\_link\_outputs](#output\_virtual\_network\_link\_outputs) | n/a |
<!-- END_TF_DOCS -->