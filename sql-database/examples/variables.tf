...
- `collation` - (Required) Specifies the collation of the database. Changing this forces a new resource to be created.
...
- `zone_redundant` - (Optional) The version of the condition.
- `elastic_pool_id` - (Optional) Specifies the ID of the elastic pool containing this database.
- `create_mode` - (Optional) The description of the role assignment.
